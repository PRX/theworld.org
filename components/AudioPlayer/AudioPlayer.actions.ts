...
export enum AudioPlayerActionTypes {
  ...
  AUDIO_PLAYER_TOGGLE_EMBED_CODE_SHOW = '[AudioPlayer] TOGGLE_EMBED_CODE_SHOW',
  AUDIO_PLAYER_COPY_EMBED_CODE_SUCCESS = '[AudioPlayer] COPY_EMBED_CODE_SUCCESS',
  AUDIO_PLAYER_COPY_EMBED_CODE_FAILURE = '[AudioPlayer] COPY_EMBED_CODE_FAILURE'
}
