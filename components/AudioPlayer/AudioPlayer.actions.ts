...
export const AudioPlayerActionTypes = {
  ...
  AUDIO_PLAYER_UPDATE_PROGRESS_TO_SEEKING:
    '[AudioPlayer] UPDATE_PROGRESS_TO_SEEKING',
...
export type AudioPlayerActionTypes =
  typeof AudioPlayerActionTypes[keyof typeof AudioPlayerActionTypes];
